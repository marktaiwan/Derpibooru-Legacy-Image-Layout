// ==UserScript==
// @name         Ponybooru Legacy Image Layout
...
const config = ConfigManager('Ponybooru Legacy Image Layout', SCRIPT_ID, 'Revert styling changes.');
...
function initCSS() {
  let CSS = '/* Generated by Ponybooru Legacy Layout */';
  const METABAR_CSS = `
#extrameta {
  padding-top: 4px;
}`;
